    ...
    return ( 
        ...
        <div className="px-5 py-24 mx-auto max-w-main-width lg:py-245px lg:px-0">
            <div className="space-y-8 lg:space-y-16">
                ...
                <Image width={280} height={444.06} src="/assets/departments/floated.png" alt="Image" className="block lg:hidden" />
        ...
        <Image width={512} height={812} src="/assets/departments/floated.png" alt="Image" className="absolute right-0 hidden top-[15%] bottom-[15%] lg:block" />
    </section>
     );
}
