...
const cards = [
    {
        src: "/assets/services/services-icon-1.png",
    ...
    {
        src: "/assets/services/services-icon-2.png",
        title: "Product design",
    ...
    {
        src: "/assets/services/services-icon-3.png",
        title: "Product design",
    ...
    {
        src: "/assets/services/services-icon-4.png",
        title: "Product design",
    ...
    return ( 
        <section className="pt-48 pb-40 bg-noise-texture backdrop-brightness-[.11]">
            <div className="px-5 mx-auto space-y-6 max-w-main-width lg:px-0">
                <div className="grid grid-cols-1 space-x-0 space-y-6 lg:space-y-0 lg:grid-cols-12 lg:w-[1120px]">
