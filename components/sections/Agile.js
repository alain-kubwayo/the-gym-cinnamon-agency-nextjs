        ...
        <section className="relative bg-highlight-70">
            <div className="px-5 mx-auto max-w-main-width lg:px-0">
                <div className="grid grid-cols-1 py-40 space-y-10 lg:grid-cols-2 lg:space-y-0">
                    ...
                    <Image width={248.5} height={161.74} src="/agile.png" alt="Image" className="block lg:hidden" />
            ...
            <Image width="338" height="220" src="/agile.png" alt="Image" className="absolute bottom-0 right-0 hidden lg:block" />
        </section>
     );
}
