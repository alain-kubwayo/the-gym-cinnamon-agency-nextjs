        ...
        <section className="relative bg-white">
            <div className="px-5 mx-auto max-w-main-width lg:px-0">
                <div className="grid grid-cols-1 py-40 space-y-10 md:grid-cols-3 md:gap-x-40 md:space-y-0">
                    <Image width={300} height={197.98} src="/assets/college/logo.png" alt="Image" className="md:col-span-1"  />
            ...
            <Image width={556} height={402} src="/assets/college/floated.png" alt="Image" className="" />
            </div>
        </section>
     );
}
